...
public interface StorageComponent extends Component {
  ...
  interface Builder {
     ...
     * characters) of a trace ID when grouping or retrieving traces. This should be disabled when
     * transitioning from 64 to 128-bit trace IDs and enabled after the transition is complete.
     *
     * <h3>Details</h3>
     *
     ...
     */
    // TODO: pick a good name and weave into server config with default false
